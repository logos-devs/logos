...
maven_install(
    artifacts = [
        # TODO : remove whatever is pulling in the android version of guava and re-enable this
        ...
        "io.grpc:grpc-netty-shaded:1.49.1",
        "io.grpc:grpc-protobuf:1.49.1",
        "io.grpc:grpc-services:1.49.1",
        ...
        "software.amazon.awssdk:ec2:2.17.278",
        "software.amazon.awssdk:s3:2.17.278",
        "software.amazon.awssdk:secretsmanager:2.17.278",
