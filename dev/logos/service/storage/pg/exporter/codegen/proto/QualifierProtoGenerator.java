...
public class QualifierProtoGenerator {
    ...
    public String generateQualifierFields(String requestType, List<QualifierDescriptor> qualifiers) {
        ...
        if (requestType.equals("List")) {
            startFieldNumber = 3; // After limit and offset
        } else if (requestType.equals("Update")) {
            startFieldNumber = 4; // After id, entity, and sparse
        } else if (requestType.equals("Delete")) {
            startFieldNumber = 2; // After id
        } else {
    ...
    /**
     * Converts a PascalCase class name to camelCase plural form.
     */
    private String camelCasePlural(String className) {
        ...
        return camelCase + "s"; // Simple pluralization
    }
