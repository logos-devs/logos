    ...
    public void generateProto(String tablesJson) throws IOException {
        ...
        for (SchemaDescriptor schemaDescriptor : schemaDescriptors) {
            for (TableDescriptor tableDescriptor : schemaDescriptor.tables()) {
                ...
                // Generate standard Proto content with the new QualifierCall approach
                // The ProtoGenerator now handles all the qualifier message generation
                String protoContent = protoGenerator.generate(buildPackage, schemaDescriptor, tableDescriptor);
