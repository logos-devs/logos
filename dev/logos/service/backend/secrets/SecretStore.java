...
public class SecretStore {
    ...
    public String getValue(String secretName) throws SecretRetrievalFailure {
        try (SecretsManagerClient client = getClient()) {
            ...
            throw new SecretRetrievalFailure();
        }
    }

    public String getTwilioSid() throws SecretRetrievalFailure {
        return this.getValue(Secrets.TwilioSid.name);
    }

    public String getTwilioAuthToken() throws SecretRetrievalFailure {
