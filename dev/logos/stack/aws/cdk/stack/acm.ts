/* TODO rewrite this in java so that apps can extend the stack in the same language as they provide services.
     we want to avoid that npm bug across bazel workspace boundaries too. Apps can, for example, set the instance sizes
     and various parameters using guice. */
